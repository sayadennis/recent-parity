...
din = '/share/fsmresfiles/breast_cancer_pregnancy/notes/initial_counsel'
dindv = '/share/fsmresfiles/breast_cancer_pregnancy/notes/initial_counsel/individual_txt'
ddev = '/share/fsmresfiles/breast_cancer_pregnancy/notes/initial_counsel/dev_set'

query = pd.read_csv(os.path.join(din, 'notes_initial_counsel.csv'), header=None)
