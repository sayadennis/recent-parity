...
dn = '/share/fsmresfiles/breast_cancer_pregnancy/data/notes/initial_counsel'

data = pd.read_csv(os.path.join(dn, 'isolated_gynecological_history_section_initial_counsel.csv'), sep='!')
...
singles.to_csv('/share/fsmresfiles/breast_cancer_pregnancy/data/formatted_parity_results.csv', index=False, header=True)
